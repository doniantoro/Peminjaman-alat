            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Detail <b>{{$data->nama_barang}}</b> </h4>
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('jumlah_barang') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah_barang" type="number" maxlength="4" class="form-control" name="jumlah_barang" value="{{ $data->jumlah_barang }}" readonly>
