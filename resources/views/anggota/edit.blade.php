                    ...
                    <div class="card-body">
                      <h4 class="card-title">Edit Anggota</h4>
                        ...
                        <div class="form-group{{ $errors->has('nim') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nim" type="text" class="form-control" name="nim" value="{{ $data->nim }}" maxlength="8" required>
                                @if ($errors->has('nim'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('anggota_id') ? ' has-error' : '' }} " style="margin-bottom: 20px;">
                            ...
                            <select class="form-control" name="anggota_id" required="">
                                ...
                                @foreach($users as $user)
                                    <option value="{{$user->id}}" {{$data->anggota_id === $user->id ? "selected" : ""}}>{{$user->name}}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
